...
{
    public record WorkOrderResult(Guid Id, string CustomerDocument, string VehicleLicensePlate, decimal Budget, string Status, DateTime DateCreated, DateTime DateFinished, TimeSpan Duration)
    {
