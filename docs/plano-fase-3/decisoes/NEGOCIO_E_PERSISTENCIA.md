...
**Complemento do usuário em 2026-09-18:** priorizar o consumo da API publicada na AWS. Remover a cópia de Init.sql e o sincronizador adicionados ao repositório da API na E1.2. SQL permanece exclusivamente no repositório de banco; eventual execução Docker terá preparação manual do esquema. A inicialização AWS por Job/pipeline do banco continua prevista, sem alteração das probes.
